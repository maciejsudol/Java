...
public class ConcurrentQuickSort {
    ...
    private class QuickSortTask <T extends Comparable <T>> implements Runnable {
        ...
        public void run () {
            synchronized (count) {
                ...
                if (count.getAndDecrement() == 1)   //Jezeli stara wartosc to 1,to nowa wartoœci¹ bedzie 0
                    count.notify();
            }
        }
        ...
        private void quicksort (int leftIdx, int rightIdx) {
            if (leftIdx < rightIdx) {
                ...
                if (count.get() >= N_THREADS) {     //Gdy przekraczamy liczbe dostepnych watkow rozpoczynamy sortowanie
    ...
    public static void main (String[] args) {
        ...
        int num1 = 1000000; //liczba elementow do posortowania
        int num2 = 8; //max liczba watkow
