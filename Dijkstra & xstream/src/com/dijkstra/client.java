...
public class client {
    public static void main(String[] args) throws IOException, ClassNotFoundException{
        ...
        try(Socket socket1 = new Socket("localhost", server1.port)) {
            ...
            System.out.println("Receiving data from first server...");
            Graph graph1 = (Graph) input1.readObject();
            System.out.println("Closing connection with first server...");
            socket1.close();
        ...
        try(Socket socket2 = new Socket("localhost", server2.port);) {
            ...
            System.out.println("Receiving data from second server...");
            String xml_graph = (String) input2.readObject();
            System.out.println("Closing connection with second server...");
            socket2.close();
